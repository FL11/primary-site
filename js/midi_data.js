function mapDataToHtmlTable() {
    var tableElement = '<table cellspacing="0" id="mytable"><tr class="header"><th>Title</th><th>Artist(s)</th><th>Notes</th><th>Collaborators</th><th>Video links</th></tr><tbody>';
    ...
    h6.innerHTML = `${midis.length} contents currently in list`;
